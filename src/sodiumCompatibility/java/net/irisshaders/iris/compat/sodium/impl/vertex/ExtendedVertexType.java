...
public class ExtendedVertexType implements ChunkVertexType {
	...
	public static final ChunkVertexType INSTANCE = new ExtendedVertexType();
	...
	public static short encodeTexture(float value) {
	...
	public ChunkVertexEncoder getEncoder() {
		return new ExtendedVertexWriter();
	}
}
